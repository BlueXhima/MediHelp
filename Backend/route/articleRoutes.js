...
router.post('/feedback', verifyToken, articleController.submitArticleFeedback);
router.get('/feedback-status/:articleId', verifyToken, articleController.getFeedbackStatus);
