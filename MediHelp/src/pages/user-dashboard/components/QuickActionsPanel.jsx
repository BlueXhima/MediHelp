...
import { redirectToNearbyHospitals, getCachedLocation, getMappingServiceUrl } from '../../../lib/locationUtils';
                ...
                <div className="mt-6 pt-4 border-t border-gray-100">
                    <div className="flex flex-wrap gap-2 justify-center">
                        <Button
                            variant="ghost"
                            size="sm"
                            className="text-xs cursor-pointer bg-transparent border text-foreground px-4 py-2 rounded-sm hover:bg-blue-600 hover:text-white"
                            onClick={handleNearbyHospitalClick}
                        >
                        ...
                        <Button variant="ghost" size="sm" className="text-xs cursor-pointer bg-transparent border text-foreground px-4 py-2 rounded-sm hover:bg-blue-600 hover:text-white">
