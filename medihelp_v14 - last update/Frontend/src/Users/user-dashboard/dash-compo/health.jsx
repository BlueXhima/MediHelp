            ...
            <div className="mb-8">
                ...
                <div className="space-y-3">
                    {upcomingMedications?.map((medication) =>
                        <div
                            key={medication?.id}
                            className="relative bg-secondary/400 border rounded-lg p-4
                            hover:bg-violet-400 transition-colors cursor-pointer hover:scale-[1.02] duration-200
                            hover:text-primary-foreground text-foreground"
                        >
                            <span className="absolute left-0 top-0 h-full w-1 bg-violet-400 rounded-l-lg"></span>
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`flex items-center space-x-1 px-3 py-1 rounded-md text-sm font-medium transition-colors cursor-pointer ${
                                        medicationTaken 
                ...
                <Link
                    to="/health-profile"
                    className="flex items-center mt-3 text-sm text-foreground font-medium hover:text-primary 
                    hover:font-semibold transition-colors bg-transparent px-4 py-3 rounded-md border border-border
                    hover:border-primary w-fit"
                >
                ...
                <div className="space-y-3">
                    {recommendedResources?.map((resource) =>
                        <Link
                            key={resource?.id}
                            to="/guidance-library"
                            className="flex items-center justify-between p-3 bg-background hover:bg-primary rounded-lg transition-all 
                            duration-200 group shadow-sm hover:scale-[1.02] text-foreground hover:text-primary-foreground"
                        >
