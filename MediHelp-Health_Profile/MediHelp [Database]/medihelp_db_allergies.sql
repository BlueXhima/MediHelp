...
CREATE TABLE `allergies` (
  ...
  KEY `fk_allergies_patient` (`PatientID`),
  CONSTRAINT `fk_allergies_patient` FOREIGN KEY (`PatientID`) REFERENCES `patient` (`PatientID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `allergies` VALUES (6,2,'test','Mild','test','2026-05-06','16:04:20',NULL,NULL);
